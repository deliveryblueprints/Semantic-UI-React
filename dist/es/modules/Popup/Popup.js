...
import * as RefUtils from '../../lib/refUtils';
...
function (_Component) {
  ...
  _createClass(Popup, [{
    ...
    value: function render() {
      ...
      if (_isNil(context)) {
        referenceElement = RefUtils.isRefObject(this.triggerRef) ? createReferenceProxy(this.triggerRef) : this.triggerRef;
      } else {
        referenceElement = RefUtils.isRefObject(context) ? createReferenceProxy(context) : context;
      }
