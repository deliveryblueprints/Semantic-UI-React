...
var RefUtils = _interopRequireWildcard(require("../../lib/refUtils"));
  ...
  (0, _createClass2["default"])(Popup, [{
    ...
    value: function render() {
      ...
      if ((0, _isNil2["default"])(context)) {
        referenceElement = RefUtils.isRefObject(this.triggerRef) ? (0, _createReferenceProxy["default"])(this.triggerRef) : this.triggerRef;
      } else {
        referenceElement = RefUtils.isRefObject(context) ? (0, _createReferenceProxy["default"])(context) : context;
      }
